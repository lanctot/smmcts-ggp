...
In this subsection, we describe eight simultaneous move games used to evaluate SM-MCTS in GGP. Some of these 
...
\textit{Pawn Whopping} is similar to Breakthrough, and is played on an 8$\times$8 board. Each player starts on
one side of the board and the goal is to move one of their pieces to the other side of the board.
