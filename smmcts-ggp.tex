...
This application of regret matching differs from Monte Carlo Counterfactual Regret 
Minimization (MCCFR)~\cite{Lanctot09mccfr} in that the regret is not counterfactual and the means of
child nodes are used to estimate expected values of the subtrees.
...
Moreover, it would be interesting to investigate how the performance of the methods depends on game complexity. 
