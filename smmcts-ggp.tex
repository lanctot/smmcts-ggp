...
In this section, we describe the foundation of our algorithms and the terminology required to formalize the techniques. 
We start by describing background information on general game playing (GGP). 
...
games: $\forall z \in \cZ, u_1(z) = k - u_2(z)$. The game begins in an initial state $s_0$. 
...
{\small Note: the left figure is taken from \cite{Bosansky13Using} and provided by Branislav Bosansky.}
\label{fig:example}}
\end{figure}
