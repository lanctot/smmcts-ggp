...
and in the node updates on lines 10 and 15. 
...
move (line \ref{alg:select}) and update a node (lines 10 and 15). 
...
The updates on line 10 and 15 add regret accumulated at the iteration to  
